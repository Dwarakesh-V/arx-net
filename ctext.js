...
<div style="text-align: left; margin-bottom: 40px;">
    <h3 style="color: var(--accent); margin-bottom: 10px; text-transform: uppercase;">
...
<h2
    style="color: var(--accent); margin-top: 40px; font-size: 1.25em; letter-spacing: 1px; border-bottom: 1px solid #333; padding-bottom: 10px;">
    1. Graph Topologies
</h2>
...
<h2
    style="color: var(--accent); margin-top: 50px; font-size: 1.25em; letter-spacing: 1px; border-bottom: 1px solid #333; padding-bottom: 10px;">
...
<div
    ...
    <h4 style="margin-top: 0; color: var(--accent-orange); font-size: 1.15em;">Breadth-First Search (BFS)</h4>
...
<div
    style="background: #1d1d1d; border: 1px solid #333; border-radius: 6px; padding: 20px; margin-bottom: 20px;">
    <h4 style="margin-top: 0; color: var(--accent-orange); font-size: 1.15em;">Depth-First Search (DFS)</h4>
...
<div
    style="background: #1d1d1d; border: 1px solid #333; border-radius: 6px; padding: 20px; margin-bottom: 20px;">
    <h4 style="margin-top: 0; color: var(--accent-orange); font-size: 1.15em;">Dijkstra's Algorithm</h4>
...
<div
    style="background: #1d1d1d; border: 1px solid #333; border-radius: 6px; padding: 20px; margin-bottom: 20px;">
    <h4 style="margin-top: 0; color: var(--accent-orange); font-size: 1.15em;">Bellman-Ford Algorithm</h4>
...
<div
    style="background: #1d1d1d; border: 1px solid #333; border-radius: 6px; padding: 20px; margin-bottom: 20px;">
    <h4 style="margin-top: 0; color: var(--accent-orange); font-size: 1.15em;">Floyd-Warshall Algorithm</h4>
...
<div
    style="background: #1d1d1d; border: 1px solid #333; border-radius: 6px; padding: 20px; margin-bottom: 20px;">
    <h4 style="margin-top: 0; color: var(--accent-orange); font-size: 1.15em;">Prim's Algorithm (Minimum Spanning Tree)
    </h4>
...
<div
    style="background: #1d1d1d; border: 1px solid #333; border-radius: 6px; padding: 20px; margin-bottom: 20px;">
    <h4 style="margin-top: 0; color: var(--accent-orange); font-size: 1.15em;">Kahn's Algorithm (Topological Sort)</h4>
...
<div
    style="background: #1d1d1d; border: 1px solid #333; border-radius: 6px; padding: 20px; margin-bottom: 20px;">
    <h4 style="margin-top: 0; color: var(--accent-orange); font-size: 1.15em;">Kosaraju's Algorithm (Strongly Connected
        Components)</h4>
...
<div style="background: #1d1d1d; border: 1px solid #333; border-radius: 6px; padding: 20px; margin-bottom: 0;">
    <h4 style="margin-top: 0; color: var(--accent-orange); font-size: 1.15em;">Hopcroft-Tarjan Algorithm (Biconnected
        Components)</h4>
